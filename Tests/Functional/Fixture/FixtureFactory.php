...
abstract class FixtureFactory
{
     ...
     * @throws \Exception
     */
    public function buildObject($objectName, array $overrideProperties = [], $addObjectToPersistence = false)
    {
     ...
     * @return object
     */
    public function createObject($objectName, $overrideProperties = [])
    {
    ...
    public function __call($methodName, array $arguments)
    {
        if (substr($methodName, 0, 5) === 'build' && strlen($methodName) > 6) {
            ...
            $overrideProperties = isset($arguments[0]) ? $arguments[0] : [];
